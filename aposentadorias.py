...
if fundamento_questao == 1:
    ...
    f"""Logo, a renúncia só tem sentido nos casos em que o valor da causa, apurado sem qualquer renúncia, seria superior a alçada, pois nesta hipótese a renúncia daria ensejo à parte litigar sob a competência do Juizado. Não é o caso dos autos, onde o valor da causa apontado já está abaixo da alçada, e a parte ré não aponta erro na sua apuração.""",
