...
if 'processo_formatado' in locals():
    ...
    beneficio = st.radio("Qual o benefício será analisado?",
                         ...
                         "36 - Auxílio-acidente previdenciário" if x==3 else
                         "41 - Aposentadoria por idade" if x==4 else
                         "42 - Aposentadoria por tempo de contribuição" if x==5 else
                         "46 - Aposentadoria especial" if x==6 else
                         "57 - Aposentadoria por tempo de serviço de professor" if x==7 else
                         "80 - Salário-maternidade" if x==8 else
